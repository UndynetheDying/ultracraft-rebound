...
public class CarpetBlock extends HorizontalConnectingBlock
{
	...
	{
		builder.add(NORTH, EAST, WEST, SOUTH, NE, ES, SW, WN, WATERLOGGED);
	}
	...
	public BlockState getPlacementState(ItemPlacementContext ctx)
	{
		...
		return applyDiagonals(state, world, pos).with(NORTH, world.getBlockState(pos.north()).isOf(this))
					   ...
					   .with(WEST, world.getBlockState(pos.west()).isOf(this)).with(WATERLOGGED, false);
	}
}
