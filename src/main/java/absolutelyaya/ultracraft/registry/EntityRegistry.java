...
public class EntityRegistry
{
	...
	public static final EntityType<MaliciousFaceEntity> MALICIOUS_FACE = Registry.register(Registries.ENTITY_TYPE,
			Ultracraft.identifier("malicious_face"),
	...
	public static final EntityType<CerberusEntity> CERBERUS = Registry.register(Registries.ENTITY_TYPE,
			Ultracraft.identifier("cerberus"),
	...
	public static final EntityType<HideousMassEntity> HIDEOUS_MASS = Registry.register(Registries.ENTITY_TYPE,
			Ultracraft.identifier("hideous_mass"),
	...
	public static final EntityType<RetaliationEntity> RETALIATION = Registry.register(Registries.ENTITY_TYPE,
			Ultracraft.identifier("retaliation"),
	...
	public static final EntityType<SwordsmachineEntity> SWORDSMACHINE = Registry.register(Registries.ENTITY_TYPE,
			Ultracraft.identifier("swordsmachine"),
	...
	public static final EntityType<StreetCleanerEntity> STREET_CLEANER = Registry.register(Registries.ENTITY_TYPE,
			Ultracraft.identifier("streetcleaner"),
	...
	public static final EntityType<GreaterFilthEntity> GREATER_FILTH = Registry.register(Registries.ENTITY_TYPE,
			Ultracraft.identifier("greaterfilth"),
	...
	public static final EntityType<HellBulletEntity> HELL_BULLET = Registry.register(Registries.ENTITY_TYPE,
			Ultracraft.identifier("hell_bullet"),
	...
	public static final EntityType<CerberusBallEntity> CERBERUS_BALL = Registry.register(Registries.ENTITY_TYPE,
			Ultracraft.identifier("cerberus_ball"),
	...
	public static final EntityType<ShotgunPelletEntity> SHOTGUN_PELLET = Registry.register(Registries.ENTITY_TYPE,
			Ultracraft.identifier("shotgun_pellet"),
	...
	public static final EntityType<CancerBulletEntity> CANCER_BULLET = Registry.register(Registries.ENTITY_TYPE,
			Ultracraft.identifier("cancer_bullet"),
	...
	public static final EntityType<EjectedCoreEntity> EJECTED_CORE = Registry.register(Registries.ENTITY_TYPE,
			Ultracraft.identifier("ejected_core"),
	...
	public static final EntityType<ThrownMachineSwordEntity> THROWN_MACHINE_SWORD = Registry.register(Registries.ENTITY_TYPE,
			Ultracraft.identifier("thrown_machinesword"),
	...
	public static final EntityType<ThrownCoinEntity> THROWN_COIN = Registry.register(Registries.ENTITY_TYPE,
			Ultracraft.identifier("thrown_coin"),
	...
	public static final EntityType<VerticalShockwaveEntity> VERICAL_SHOCKWAVE = Registry.register(Registries.ENTITY_TYPE,
			Ultracraft.identifier("vertical_shockwave"),
	...
	public static final EntityType<InterruptableCharge> INTERRUPTABLE_CHARGE = Registry.register(Registries.ENTITY_TYPE,
			Ultracraft.identifier("interruptable_charge"),
	...
	public static final EntityType<SoulOrbEntity> SOUL_ORB = Registry.register(Registries.ENTITY_TYPE,
			Ultracraft.identifier("soul_orb"),
	...
	public static final EntityType<BloodOrbEntity> BLOOD_ORB = Registry.register(Registries.ENTITY_TYPE,
			Ultracraft.identifier("blood_orb"),
	...
	public static final EntityType<StainedGlassWindow> STAINED_GLASS_WINDOW = Registry.register(Registries.ENTITY_TYPE,
			Ultracraft.identifier("stained_glass_window"),
	...
	public static final EntityType<ProgressionItemEntity> PROGRESSION_ITEM = Registry.register(Registries.ENTITY_TYPE,
			Ultracraft.identifier("progression_item"),
	...
	public static final TagKey<EntityType<?>> PROJBOOSTABLE = TagKey.of(RegistryKeys.ENTITY_TYPE, Ultracraft.identifier("projboostable"));
	public static final TagKey<EntityType<?>> LIVING = TagKey.of(RegistryKeys.ENTITY_TYPE, Ultracraft.identifier("living"));
	public static final TagKey<EntityType<?>> NON_LIVING = TagKey.of(RegistryKeys.ENTITY_TYPE, Ultracraft.identifier("non-living"));
	public static final TagKey<EntityType<?>> PROJECTILES = TagKey.of(RegistryKeys.ENTITY_TYPE, Ultracraft.identifier("projectile"));
	public static final TagKey<EntityType<?>> HUSKS = TagKey.of(RegistryKeys.ENTITY_TYPE, Ultracraft.identifier("husks"));
	public static final TagKey<EntityType<?>> MACHINES = TagKey.of(RegistryKeys.ENTITY_TYPE, Ultracraft.identifier("machines"));
	public static final TagKey<EntityType<?>> DEMONS = TagKey.of(RegistryKeys.ENTITY_TYPE, Ultracraft.identifier("demons"));
	public static final TagKey<EntityType<?>> ANGELS = TagKey.of(RegistryKeys.ENTITY_TYPE, Ultracraft.identifier("angels"));
	public static final TagKey<EntityType<?>> BIG_FUNIS = TagKey.of(RegistryKeys.ENTITY_TYPE, Ultracraft.identifier("funis"));
	public static final TagKey<EntityType<?>> STREETCLEANER_DODGE = TagKey.of(RegistryKeys.ENTITY_TYPE, Ultracraft.identifier("streetcleaner_dodge"));
	public static final TagKey<EntityType<?>> STREETCLEANER_COUNTER = TagKey.of(RegistryKeys.ENTITY_TYPE, Ultracraft.identifier("streetcleaner_counter"));
	public static final TagKey<EntityType<?>> EXPLOSION_AFFECTED_PROJECTILES = TagKey.of(RegistryKeys.ENTITY_TYPE, Ultracraft.identifier("explosion_affected_projectiles"));
	public static final TagKey<EntityType<?>> NO_RAGE_TINT = TagKey.of(RegistryKeys.ENTITY_TYPE, Ultracraft.identifier("no_rage_tint"));
