...
public class JumpstartHookRenderer extends EntityRenderer<JumpstartHookEntity>
{
	final Identifier TEXTURE = Ultracraft.texIdentifier("textures/entity/jumpstart_hook");
	
	public JumpstartHookRenderer(EntityRendererFactory.Context context)
	{
		super(context);
	}
	
	@Override
	public void render(JumpstartHookEntity entity, float yaw, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light)
	{
		matrices.push();
	...
	@Override
	public Identifier getTexture(JumpstartHookEntity entity)
	{
		return TEXTURE;
	}
}
