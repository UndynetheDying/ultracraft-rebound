...
{
	static final Identifier TEXTURE = Ultracraft.texIdentifier("textures/item/nail");
	static final Identifier TEXTURE_HOT = Ultracraft.texIdentifier("textures/item/nail_hot");
